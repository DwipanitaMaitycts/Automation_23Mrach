...
class LevisMyAccountPage extends Page{
  ...
  def  ChangeLocale1() {
      ...
      //driver.navigate().to("https://prepod-100-web-000.levi-site.com/DE/de_DE")
	  Thread.sleep(2000)
	  return true
   }
  def  ChangeLocale1_DK() {
	  driver.navigate().to("https://qa-500-web-000.dockers-site.com/DE/de_DE")
      //driver.navigate().to("https://prepod-100-web-000.dockers-site.com/DE/de_DE")
	  Thread.sleep(2000)
	  return true
   }
    def  ChangeLocale2() {
	  driver.navigate().to("https://qa-500-web-000.levi-site.com/GB/en_GB/my-account")
	  //driver.navigate().to("https://preprod-001-web-000.levi-site.com/GB/en_GB/my-account")
	  Thread.sleep(2000)
	  return true
   }
  ...
  def Remove(String){
	  String Remove = $(".box.default>h4").text()
	  return true
  }
  ...
  //Added By Dipannita
   def VerifyOrderDetailsFromOrderHistory() throws NumberFormatException{
	   ...
	   //verifies product image displays
